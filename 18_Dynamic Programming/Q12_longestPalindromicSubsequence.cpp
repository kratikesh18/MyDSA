...
int main(){
    ...
    //creating the ppalindrominc  stings 
    string first = str;
    ...
    cout<<"the answer by recursion is : "<<byRecursion(first, second , i , j)<<endl;
    ...
    cout<<"the answer by Memoisation is: "<<byMemoisation(first,second , i  , j , dp)<<endl;
    
    // by tabulation method 
    cout<<"the answer by tabulation method is: "<<byTabulation(first, second)<<endl;

    //by space optimised solution
    cout<<"tha answer by space optimised method is: "<<bySpaceOptimisation(first,second)<<endl;
